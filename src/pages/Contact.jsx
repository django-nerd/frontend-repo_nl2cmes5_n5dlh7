      ...
      <form className="mt-10 grid gap-6">
        {[
          ...
          <div key={f.id} className="relative">
            <input id={f.id} type={f.type} placeholder=" " className="w-full rounded-lg bg-transparent border border-yellow-500/30 focus:border-yellow-400/80 outline-none p-4 text-white placeholder:text-transparent peer" />
        ...
        <div className="relative">
          <textarea id="message" rows="5" placeholder=" " className="w-full rounded-lg bg-transparent border border-yellow-500/30 focus:border-yellow-400/80 outline-none p-4 text-white placeholder:text-transparent peer" />
        ...
        <button type="submit" className="group inline-flex items-center justify-center rounded-full bg-gradient-to-br from-yellow-500 to-amber-600 px-6 py-3 text-black font-medium shadow-[0_0_0_rgba(0,0,0,0)] hover:shadow-[0_0_32px_rgba(212,175,55,0.25)] transition">
          Envoyer
