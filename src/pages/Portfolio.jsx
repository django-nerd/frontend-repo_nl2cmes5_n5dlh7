        ...
        {items.map((it, i) => (
          ...
          >
            <div className="aspect-[4/3] overflow-hidden">
              <img src={it.img} alt="" className="h-full w-full object-cover transform group-hover:scale-[1.04] transition duration-500" />
            </div>
            ...
            <div className="absolute bottom-0 p-4 w-full flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-yellow-300/80">{it.tag}</p>
              </div>
